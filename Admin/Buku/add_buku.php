...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO buku (kode_buku, judul_buku, pengarang, penerbit, tanggal_terbit, bahasa, kategori, jumlah_halaman, deskripsi_buku, cover) 
                                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$kode_buku, $judul_buku, $pengarang, $penerbit, $tanggal_terbit, $bahasa, $kategori, $jumlah_halaman, $deskripsi_buku, $cover_name]);
