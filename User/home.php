...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .bottom-nav a.active {
        color: var(--primary);
        background-color: #f0f0f0; /* Latar belakang opsional */
        font-weight: bold;
      }
    </style>
  </head>
  <body>
    ...
    <section class="container mt-4">
      <h3 class="fw-bold mb-4 m-2">Recommended Books</h3>
      <div class="row g-4">
        <!-- Card 1 -->
        <div class="col-md-4">
          <div class="card h-100">
            <img
              src="../Assets/Img/853c3e7a77e8e0fd5f4bf582ca0c47b0.jpg"
              alt="Book 1"
            />
            <div class="card-body">
              <h5 class="card-title">
                Bridging the Gap to Tomorrow's Classroom
              </h5>
              <p class="card-text">
                A short description of the book goes here. Engage your audience!
              </p>
        ...
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Discover fascinating insights with this incredible book.
              </p>
              <a href="#" class="btn btn-primary w-100">Read More</a>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Explore amazing stories and gain knowledge effortlessly.
              </p>
              <a href="#" class="btn btn-primary w-100">Read More</a>
            </div>
          </div>
